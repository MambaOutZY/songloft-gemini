...
Default support: **MP3, FLAC, WAV, APE, OGG, M4A, MP4, MOV, WMA, AIF/AIFF, MKA, MKV, WebM, AVI, TS, MPG, Opus, M4B, OGA, MPEG, M4V, FLV, WMV, RM/RMVB, 3GP** (27 formats, including audio and video containers). See the `SupportedFormats` default in `internal/app/app.go` for the full list. This can be customized via the `SupportedFormats` field of the database configuration `scan_config`.
