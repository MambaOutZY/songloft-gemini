...
Songloft 是一款**自托管的本地音乐服务器**，旨在让用户在自有硬件上统一管理和播放本地音乐与网络音源。项目当前版本以 [Makefile](https://github.com/songloft-org/songloft/blob/main/Makefile) 中的 `VERSION` 变量为准（截至本文编写时为 **2.12.1**），源代码采用 Apache 2.0 许可证开源（客户端二进制因链接 GPL-3.0 的 WebF 而按 GPL-3.0 分发，详见 README 的许可证章节）。
...
- [internal/app/app.go:38-68](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L38-L68) -- App 结构体字段一览（展示各核心组件）
...
**图表来源**
- [internal/app/app.go:38-68](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L38-L68) -- App 结构体展示了各子系统的组合关系
...
- [internal/app/app.go:38-68](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L38-L68) -- 核心组件一览
