...
默认支持：**MP3、FLAC、WAV、APE、OGG、M4A、MP4、MOV、WMA、AIF/AIFF、MKA、MKV、WebM、AVI、TS、MPG、Opus、M4B、OGA、MPEG、M4V、FLV、WMV、RM/RMVB、3GP**（27 种，含音频与视频容器）。完整列表见 `internal/app/app.go` 中 `SupportedFormats` 默认值。可通过数据库配置 `scan_config` 的 `SupportedFormats` 字段自定义。
